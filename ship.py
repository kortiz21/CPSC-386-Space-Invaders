...
class Ship(Sprite):
    ...
    ship_explosion_images = [pg.transform.rotozoom(pg.image.load(f'images/ship_explode{n}.png'),
                                                   0, 1.0) for n in range(8)]
    ...
    def really_dead(self):
        self.ships_left -= 1
        self.game.scoreboard.prep_ships(self.ships_left)
